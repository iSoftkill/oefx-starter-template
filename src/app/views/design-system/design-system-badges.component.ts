...
@Component({
  ...
  template: `
    <div class="ds-container">
      ...
      <!-- Sección 1: Componente Reutilizable Angular (Shared) -->
      ...
      <!-- Sección 2: Variantes de Tamaño y Soporte Dot (WCAG SC 1.4.1) -->
      <div class="card ds-card">
        <div class="card-header">
      ...
      <!-- Sección 3: Chips Específicos de Proyectos, SIGED y Áreas (&lt;oefa-chip&gt;) -->
      <div class="card ds-card">
        <div class="card-header">
          <h3>3. Chips Específicos de Negocio (&lt;oefa-chip&gt;)</h3>
