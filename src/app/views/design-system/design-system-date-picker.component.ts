    ...
    <div class="ds-container">
      ...
      <div class="card ds-card">
        <div class="card-header">
          ...
          <span class="text-muted">Componentes standalone compatibles con Reactive Forms y ngModel desde <code>shared/components/</code>.</span>
        </div>
        <div class="card-body">
          <pre class="code-block">&lt;!-- Selector Simple --&gt;
&lt;oefa-date-picker
  label="Fecha de Notificación Oficial"
  [required]="true"
...
/&gt;</pre>
  ...
  styles: [`
    ...
    .value-preview { margin-top: 16px; font-size: 0.875rem; font-family: var(--oefa-font-mono); color: var(--oefa-text-secondary); background: var(--oefa-surface-subtle); border: 1px solid var(--oefa-border-color); padding: 10px 14px; border-radius: var(--oefa-radius-md); }
    .code-block {
